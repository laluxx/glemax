...
(custom-theme-set-faces 'flatwhite
  ...
  '(region                                    ((t (:background "#d8d4cd" :extend t))))

  '(shadow                                    ((t (:foreground "#605a52"))))
  '(highlight                                 ((t (:foreground "#f1ece4" :background "#7382a0"))))
  ...
  '(completions-common-part                   ((t (:foreground "blue3"))))
  '(completions-first-difference              ((t (:inherit bold))))

  '(rainbow-delimiters-depth-1-face           ((t (:foreground "#7382a0"))))
  '(rainbow-delimiters-depth-2-face           ((t (:foreground "#9c739c"))))
  '(rainbow-delimiters-depth-3-face           ((t (:foreground "#81895d"))))
  '(rainbow-delimiters-depth-4-face           ((t (:foreground "#957f5f"))))
  '(rainbow-delimiters-depth-5-face           ((t (:foreground "#5f8c7d"))))
  '(rainbow-delimiters-depth-6-face           ((t (:foreground "#955f5f"))))
  '(rainbow-delimiters-depth-7-face           ((t (:foreground "#81895d"))))
  '(rainbow-delimiters-depth-8-face           ((t (:foreground "#81895d"))))
  '(rainbow-delimiters-depth-9-face           ((t (:foreground "#9c739c"))))
  '(rainbow-delimiters-unmatched-face         ((t (:foreground "#f7f3ee" :background "#955f5f" :weight bold))))
  '(rainbow-delimiters-mismatched-face        ((t (:inherit rainbow-delimiters-unmatched-face))))

  '(escape-glyph                              ((t (:foreground "#5f8c7d"))))

  '(isearch                                   ((t (:inherit lazy-highlight))))
  '(isearch-fail                              ((t (:foreground "#f1ece4" :background "#955f5f"))))
  '(lazy-highlight                            ((t (:foreground "#4c5361" :background "#e8e4ff"))))
)
