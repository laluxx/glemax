...
(custom-theme-set-faces 'molokai
  ...
  '(region                                    ((t (:background "#4e4e4e" :extend t))))
  ...
  '(rainbow-delimiters-depth-1-face           ((t (:foreground "#fb2874"))))
  ...
  '(rainbow-delimiters-depth-5-face           ((t (:foreground "#fb2874"))))
  ...
  '(rainbow-delimiters-unmatched-face         ((t (:foreground "#1C1E1F" :background "#e74c3c" :weight bold))))
  '(rainbow-delimiters-mismatched-face        ((t (:inherit rainbow-delimiters-unmatched-face))))

  '(escape-glyph                              ((t (:foreground "#66d9ef"))))

  '(isearch                                   ((t (:foreground "#1B2229" :background "#b6e63e"))))
  '(isearch-fail                              ((t (:foreground "#1B2229" :background "#e74c3c"))))
  '(lazy-highlight                            ((t (:foreground "#1B2229" :background "#9c91e4"))))
)
