...
(custom-theme-set-faces 'modus-vivendi-tinted
  ...
  '(font-lock-regexp-grouping-backslash       ((t (:foreground "#f78fe7" :weight bold))))
  '(font-lock-regexp-grouping-construct       ((t (:foreground "#b6a0ff" :weight bold))))
  '(font-lock-string-face                     ((t (:foreground "#2fafff"))))
  '(font-lock-type-face                       ((t (:foreground "#11c777" :weight bold))))
  '(font-lock-variable-name-face              ((t (:foreground "#4ae2f0"))))
  '(font-lock-variable-use-face               ((t (:foreground "#76afbf"))))
  '(font-lock-warning-face                    ((t (:foreground "#d0bc00" :weight bold))))

  '(minibuffer-prompt                         ((t (:foreground "#4ae2f0"))))
  '(region                                    ((t (:foreground "#ffffff" :background "#555a66" :extend t))))

  '(shadow                                    ((t (:foreground "#989898"))))
  '(highlight                                 ((t (:foreground "#ffffff" :background "#45605e"))))
  '(help-key-binding                          ((t (:foreground "#b6a0ff"))))
  '(completions-highlight                     ((t (:background "#483d8a" :weight bold))))
  ...
  '(escape-glyph                              ((t (:foreground "#b6a0ff"))))
