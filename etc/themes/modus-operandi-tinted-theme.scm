...
(custom-theme-set-faces 'modus-operandi-tinted
  ...
  '(font-lock-regexp-grouping-backslash       ((t (:foreground "#8f0075" :inherit bold))))
  '(font-lock-regexp-grouping-construct       ((t (:foreground "#531ab6" :inherit bold))))
  '(font-lock-string-face                     ((t (:foreground "#00598b"))))
  '(font-lock-type-face                       ((t (:foreground "#306010" :inherit bold))))
  '(font-lock-variable-name-face              ((t (:foreground "#00603f"))))
  '(font-lock-variable-use-face               ((t (:foreground "#2a5045"))))
  '(font-lock-warning-face                    ((t (:foreground "#6d5000" :inherit bold)))
))
