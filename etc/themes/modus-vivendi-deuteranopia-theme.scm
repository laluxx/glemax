...
(custom-theme-set-faces 'modus-vivendi-deuteranopia
  ...
  '(mode-line           ((t (:foreground "#f0f0f0" :background "#2a2a6a"))))
  '(mode-line-active    ((t (:foreground "#f0f0f0" :background "#2a2a6a"))))
  ...
  '(font-lock-regexp-grouping-backslash       ((t (:foreground "#00bcff" :inherit bold))))
  '(font-lock-regexp-grouping-construct       ((t (:foreground "#d8af7a" :inherit bold))))
  '(font-lock-string-face                     ((t (:foreground "#79a8ff"))))
  '(font-lock-type-face                       ((t (:foreground "#6ae4b9" :inherit bold))))
  '(font-lock-variable-name-face              ((t (:foreground "#00d3d0"))))
  '(font-lock-variable-use-face               ((t (:foreground "#76afbf"))))
  '(font-lock-warning-face                    ((t (:foreground "#cabf00" :inherit bold)))
))
