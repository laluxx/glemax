...
(custom-theme-set-faces 'modus-operandi-deuteranopia
  ...
  '(mode-line           ((t (:foreground "#0f0f0f" :background "#d0d6ff"))))
  '(mode-line-active    ((t (:foreground "#0f0f0f" :background "#d0d6ff"))))
  ...
  '(font-lock-regexp-grouping-backslash       ((t (:foreground "#0000b0" :inherit bold))))
  '(font-lock-regexp-grouping-construct       ((t (:foreground "#77492f" :inherit bold))))
  '(font-lock-string-face                     ((t (:foreground "#3548cf"))))
  '(font-lock-type-face                       ((t (:foreground "#005f5f" :inherit bold))))
  '(font-lock-variable-name-face              ((t (:foreground "#005e8b"))))
  '(font-lock-variable-use-face               ((t (:foreground "#4a3a8a"))))
  '(font-lock-warning-face                    ((t (:foreground "#695500" :inherit bold)))
))
