...
(custom-theme-set-faces 'modus-operandi-deuteranopia
  ...
  '(region                                    ((t (:foreground "#000000" :background "#bdbdbd" :extend t))))
  ...
  '(completions-common-part                   ((t (:foreground "#3548cf" :weight bold))))
  '(completions-first-difference              ((t (:foreground "#973300" :weight bold))))

  '(rainbow-delimiters-depth-1-face           ((t (:foreground "#0031a9"))))
  '(rainbow-delimiters-depth-2-face           ((t (:foreground "#695500"))))
  '(rainbow-delimiters-depth-3-face           ((t (:foreground "#3548cf"))))
  '(rainbow-delimiters-depth-4-face           ((t (:foreground "#77492f"))))
  '(rainbow-delimiters-depth-5-face           ((t (:foreground "#0000b0"))))
  '(rainbow-delimiters-depth-6-face           ((t (:foreground "#973300"))))
  '(rainbow-delimiters-depth-7-face           ((t (:foreground "#003497"))))
  '(rainbow-delimiters-depth-8-face           ((t (:foreground "#624416"))))
  '(rainbow-delimiters-depth-9-face           ((t (:foreground "#005e8b"))))
  '(rainbow-delimiters-unmatched-face         ((t (:foreground "#000000" :background "#f3d000"))))
  '(rainbow-delimiters-mismatched-face        ((t (:foreground "#000000" :background "#dfa0f0"))))

  '(escape-glyph                              ((t (:foreground "#0000b0" :weight bold))))

  '(isearch                                   ((t (:foreground "#000000" :background "#f3d000"))))
  '(isearch-fail                              ((t (:foreground "#000000" :background "#f3d000"))))
  '(lazy-highlight                            ((t (:foreground "#000000" :background "#bfc9ff"))))
)
